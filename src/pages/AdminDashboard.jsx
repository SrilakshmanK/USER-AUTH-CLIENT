  ...
  return (
    <div className="container mx-auto mt-10 p-6">
      ...
      <div className="flex items-center mb-4">
        <h3 className="text-xl font-semibold mr-4">User Management</h3>
        <button
          className="bg-green-600 hover:bg-green-700 text-white font-semibold py-2 px-4 rounded shadow transition duration-200 focus:outline-none focus:ring-2 focus:ring-green-400 focus:ring-opacity-50"
        >
          Add User
        </button>
      </div>
